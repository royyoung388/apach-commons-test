 ...
 * @version $Id: TestPropertiesConfigurationLayout.java 1842194 2018-09-27 22:24:23Z ggregory $
 */
public class TestPropertiesConfigurationLayout
{
    ...
    private static final String TEST_COMMENT = "A comment for set test property";
    ...
    {
        builder.addComment("This is set test properties file,");
    ...
    public void testSave() throws ConfigurationException
    {
        ...
        layout.setHeaderComment("A header comment" + CRNORM + "for set properties");
        checkLayoutString("# A header comment" + CR + "# for set properties"
