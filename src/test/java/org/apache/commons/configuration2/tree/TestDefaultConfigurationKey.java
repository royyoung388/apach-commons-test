 ...
 *
 * @author Oliver Heger
 * @version $Id: TestDefaultConfigurationKey.java 1842194 2018-09-27 22:24:23Z ggregory $
 */
public class TestDefaultConfigurationKey
{
    ...
    public void testIterateEscapedDelimiters()
    {
        ...
        key.append(".strange");
        assertEquals("set..elem.trailing..dot...strange", key.toString());
        final DefaultConfigurationKey.KeyIterator kit = key.iterator();
        assertEquals("Wrong first part", "set.elem", kit.nextKey());
    ...
    public void testIterateWithoutEscapeDelimiter()
    {
        ...
        key = new DefaultConfigurationKey(expressionEngine);
        key.append("..set..elem.trailing..dot...strange");
        assertEquals("Wrong key", "set..elem.trailing..dot...strange", key
                .toString());
        final DefaultConfigurationKey.KeyIterator kit = key.iterator();
        final String[] parts =
        {"set", "elem", "trailing", "dot", "strange"};
