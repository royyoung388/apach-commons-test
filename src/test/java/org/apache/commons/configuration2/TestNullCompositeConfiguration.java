 ...
 *
 * @version $Id: TestNullCompositeConfiguration.java 1842194 2018-09-27 22:24:23Z ggregory $
 */
public class TestNullCompositeConfiguration
{
    ...
    public void testSettingMissingProperty() throws Exception
    {
        cc.addConfiguration(conf1);
        cc.addConfiguration(xmlConf);
        cc.setProperty("set.new.property", "supernew");
        assertEquals("supernew", cc.getString("set.new.property"));
    }
