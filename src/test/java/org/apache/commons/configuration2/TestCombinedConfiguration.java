 ...
 *
 * @version $Id: TestCombinedConfiguration.java 1842194 2018-09-27 22:24:23Z ggregory $
 */
public class TestCombinedConfiguration
{
    ...
    {
        final AbstractConfiguration c = setUpTestConfiguration();
        config.addConfiguration(c, null, "set");
        checkAddConfig(c);
        assertTrue("Wrong property value", config.getBoolean("set." + TEST_KEY));
    }
